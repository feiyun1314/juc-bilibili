...
/**
 * @auther zzyy
 * @create 2022-01-20 10:52  wait() join() sleep() 方法都会清空标识状态
 *       调用sleep()方法会抛出InterruptedException后，中断标识也被清空状态为false，我们再catch没有通过调用
 *       th.interrupt()方法再次将中断标识置为true，这就导致无限循环了
 *
 *
 *  * 1 中断标志位，默认false
